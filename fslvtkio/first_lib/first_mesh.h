...
template<class T>
static std::vector< std::vector<T> >  findNeighbours(const std::vector< std::vector<T> > & cells, const unsigned int & N);

template<class T>
static std::vector< std::vector<T> > findNeighbourTriangles(const std::vector< std::vector<T> > & cells, const unsigned int & N);



template<class T, class T2>
static void maxTriangle(const std::vector<T> & pts, const std::vector< std::vector<T2> > & localTri, const std::vector< std::vector<T2> > & cells,std::vector<T> & vx, std::vector<T> & vy, std::vector<T> & vz );

template<class T,class T2>
static bool self_intersection_test(const std::vector< std::vector<T2> > & tri_cells, const std::vector<T> & pts);
...
template<class T,class T2>
static void normal(const std::vector<T> & pts, const std::vector< std::vector<T2> > & localTri, const std::vector< std::vector<T2> > & cells,std::vector<T> & vx, std::vector<T> & vy, std::vector<T> & vz );


template<class T,class T2>
static void  medium_neighbours(const std::vector<T> & pts, const std::vector< std::vector<T2> > & neighbours, const std::vector< std::vector<T2> > & cells,\
